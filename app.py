...
# --- BASE DE DADOS ---
atrativos_db = {
    "Cataratas do Iguaçu": {"cat": "Natureza", "R": 5.0, "desc": "Quedas d'água famosas."},
    ...
    "Usina de Itaipu": {"cat": "Cultura", "R": 4.7, "desc": "Maior usina em produção."},
    ...
    "Iguazu Wellness": {"cat": "Experiência", "R": 4.6, "desc": "Relaxamento e bem-estar."},
...
with tab2:
    st.write("Mapa em processamento de dados...")
