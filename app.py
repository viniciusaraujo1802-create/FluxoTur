...
with tab1:
    ...
    if btn_clicado or pesquisa:
        with st.spinner("Analisando dados..."):
            ...
            # Embaralha a lista para que a ordem mude a cada clique
...
with tab3:
    ...
    st.write("O FluxoTur utiliza uma arquitetura de IA Não Generativa focada em dados reais e verificáveis.")
